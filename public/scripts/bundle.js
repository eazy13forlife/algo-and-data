...
var longestSubstring = function longestSubstring(array, target) {
  var maxArrayLength = -Infinity;
  var startWindow = 0;
  var frequencyObject = {};
  var frequencyOf1 = void 0;

  for (var endWindow = 0; endWindow < array.length; endWindow++) {
    var number = array[endWindow];
    ...
    while (endWindow - startWindow + 1 - frequencyOf1 > target) {
      var startNumber = array[startWindow];
      startWindow += 1;
