...
var smallestWindowSubstring = function smallestWindowSubstring(string, pattern) {
  var minLength = Infinity;
  var startWindow = 0;
  var frequencyMatch = 0;
  var subStart = 0; // keeps track of which index our min substring starts
